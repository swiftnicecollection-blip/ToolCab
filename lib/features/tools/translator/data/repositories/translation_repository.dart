...
class TranslationRepository {
  ...
  /// Saves a translation history entry.
  Future<void> saveHistoryEntry(TranslationHistoryEntry entry) async {
  ...
  /// Returns a list of translation history entries (newest first).
  Future<List<TranslationHistoryEntry>> getHistoryEntries() async {
    final List<Map<String, dynamic>> entries = await _readHistoryEntries();
    return entries
  ...
  Future<void> updateHistoryEntry(TranslationHistoryEntry entry) async {
    final List<Map<String, dynamic>> entries = await _readHistoryEntries();
