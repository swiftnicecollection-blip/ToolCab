...
/// History tile for a speech-to-text entry.
class SttHistoryTile extends StatelessWidget {
  const SttHistoryTile({
    super.key,
    required this.entry,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (entry.duration != null) ...<Widget>[
                  ...
                  Text(
                    '${entry.duration!.inSeconds}s • ${entry.wordCount} words',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                          color: AppColors.categorySpeech,
                        ),
                  ),
